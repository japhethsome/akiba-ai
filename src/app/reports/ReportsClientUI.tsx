...
export function ReportsClientUI({ initialSettings }: ReportsClientUIProps) {
  ...
  const generateEmailHtml = (data: any) => {
    ...
    return `
      <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #171d1a; padding: 20px; border: 1px solid #e4eae4; border-radius: 16px;">
        ...
        <p style="font-size: 11px; color: #6d7a73; text-align: center; margin-top: 30px;">Generated automatically by Akiba Yangu System</p>
      </div>
    `;
  };
  ...
  const getMailtoLink = (data: any) => {
    ...
    body += `\nGenerated via Akiba Yangu System.`;
    ...
    printWindow.document.write(`
      <html>
        ...
        <body>
          ...
          <div class="footer">
            <div>Generated by Akiba Yangu System</div>
            <div>Page 1 of 1</div>
