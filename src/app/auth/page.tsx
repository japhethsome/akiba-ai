...
const translations = {
  ...
  sw: {
    ...
    form: {
      ...
      registerDesc: "Jiunge na biashara 500+ za Kenya kwenye Akiba AI.",
      loginTab: "Ingia",
      registerTab: "Jisajili",
      phoneLabel: "Nambari ya Simu (Iliyounganishwa na M-Pesa)",
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-10">
          ...
          >
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <input type="text" placeholder="Wanjiku Maina"
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <input type="text" placeholder="Eldo Groceries"
                        className="w-full h-14 pl-12 pr-4 bg-[#f5fbf5] border-2 border-[#bccac1] rounded-2xl text-sm font-medium outline-none focus:border-[#00694c] focus:bg-white transition-all shadow-sm" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="group">
                      <label className="block text-[10px] font-black uppercase tracking-[0.2em] mb-2 text-[#3d4943]">{t.form.role}</label>
                      <div className="flex gap-2 p-1 bg-[#f0f4f0] rounded-xl border border-[#bccac1]">
                        {(["owner", "attendant"] as const).map((r) => (
                          <button key={r} type="button" onClick={() => setRole(r)}
                            className={`flex-1 py-2 rounded-lg text-[10px] font-black uppercase transition-all ${role === r ? "bg-[#00694c] text-white shadow-md" : "text-[#6d7a73]"}`}
                          >
                            {r === "owner" ? t.form.ownerRole : t.form.attendantRole}
                          </button>
                        ))}
                      </div>
                    </div>
              ...
              <Link href="/dashboard" className="flex items-center justify-center gap-3 w-full h-14 rounded-2xl font-black text-sm text-white bg-gradient-to-r from-[#00694c] to-[#008560] shadow-xl shadow-[#00694c]/20 hover:scale-[1.02] active:scale-[0.98] transition-all">
                {mode === "login" ? t.form.signInBtn : t.form.createAccountBtn}
