...
export default function AISurveyClient() {
  ...
  return (
    <div className="min-h-screen bg-[#f5fbf5] flex items-center justify-center p-8 text-[#171d1a]">
      <div className="max-w-2xl w-full">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="space-y-12 bg-white p-12 rounded-[40px] border border-[#bccac1] shadow-xl shadow-[#00694c]/5"
          >
            <div className="space-y-4">
              <div className="w-16 h-16 rounded-2xl bg-[#00694c]/10 flex items-center justify-center">
                 <span className="material-symbols-outlined text-[#00694c] text-3xl">{questions[currentStep].icon}</span>
              </div>
              <h1 className="text-4xl font-black text-[#171d1a] leading-tight tracking-tight">
            ...
            <div className="grid gap-3">
              {questions[currentStep].options.map((option) => (
                <button
                  ...
                  className="group p-6 rounded-[24px] bg-[#f5fbf5] border border-[#bccac1]/50 text-left hover:border-[#00694c] hover:bg-white hover:shadow-lg transition-all flex items-center justify-between"
                >
                  <span className="text-lg font-bold text-[#171d1a]/70 group-hover:text-[#00694c] transition-colors">{option}</span>
